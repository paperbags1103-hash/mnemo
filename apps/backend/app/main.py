...
from app.api.v1 import categories, digest, enrich, graph, health, ingest, links, lorien, notes, search, tree, webhook
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=settings.cors_origins + [o.strip() for o in settings.cors_extra.split(",") if o.strip()],
